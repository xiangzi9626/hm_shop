...
<style>
	...
	@font-face {font-family: "iconfont";
	  src: url('http://www.123.com/font_nav/iconfont.eot?t=1576844226174'); /* IE9 */
	  src: url('http://www.123.com/font_nav/iconfont.eot?t=1576844226174#iefix') format('embedded-opentype'), /* IE6-IE8 */
	  ...
	  url('http://www.123.com/font_nav/iconfont.woff?t=1576844226174') format('woff'),
	  url('http://www.123.com/font_nav/iconfont.ttf?t=1576844226174') format('truetype'), /* chrome, firefox, opera, Safari, Android, iOS 4.2+ */
	  url('http://www.123.com/font_nav/iconfont.svg?t=1576844226174#iconfont') format('svg'); /* iOS 4.1- */
	}
